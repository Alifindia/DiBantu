        ...
        <div className="bg-amber-50 border-l-4 border-amber-400 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-700 mt-1">
              Helper hanya membantu proses manual melalui platform resmi. <strong>TIDAK menggunakan bot, TIDAK bypass antrean, TIDAK minta password akun Anda.</strong> TemuJasa dan helper tidak menjamin tiket pasti didapat.
            </p>
          </div>
        </div>
